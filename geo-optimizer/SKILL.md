---
name: geo-optimizer
description: Make websites visible and citable by AI search engines (ChatGPT Search, Perplexity, Claude, Gemini AI Overviews). Implements the GEO audit framework plus a 47-method citability engine based on Princeton KDD 2024 research. Use when optimizing AI search visibility, analyzing AI bot crawlers, or auditing content for RAG readability and citations.
---
